...
export async function getDashboard(req, res) {
    try {
        ...
        if (existing) {
            ...
            const dashboardData = existing.dashboardJson;
            return res.json({
                success: true,
                data: {
                    ...dashboardData,
 ...
 */
export async function discoverUniversities(req, res) {
    try {
 ...
 */
export async function shortlistUniversities(req, res) {
    try {
 ...
 */
export async function aiCounselor(req, res) {
    try {
        ...
        const isDistressed = distressKeywords.some(keyword => message.toLowerCase().includes(keyword));
